...
kazu=Num.count-1
CSV.open('nctr1010pt.csv','w') do |test|
	for i in 0..kazu do
		test << [Num[i], Xx[i],Yy[i],arei.Crd1[i],arei.Crd2[i],arei.Crd3[i],arei.Crd4[i],arei.Crd5[i],arei.Crd6[i],arei.Crd7[i],arei.Crd8[i],arei.Crd9[i],arei.Onaji1[i],arei.Onaji2[i],arei.Onaji3[i],arei.Onaji4[i],arei.Onaji5[i],arei.Onaji6[i],arei.Onaji7[i],arei.Onaji8[i],arei.Onaji9[i]]
	end
end	